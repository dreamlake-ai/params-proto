...
order: 0
description: "Introduction \u2014 params-proto 3.3.0 documentation."
---
...
See **[Environment Variables Guide](/key_concepts/environment_variables)** for comprehensive documentation including template expansion, security considerations, and common patterns.

## Learn More

The Quick Start covers the basics. For deeper understanding, see:

- **[Core Concepts](/key_concepts/core-concepts)** - The three main decorators (@proto, @proto.cli, @proto.prefix)
- **[Configuration Patterns](/key_concepts/configuration-patterns)** - Functions vs classes, when to use each

**Building CLIs** (related guides for creating command-line interfaces):
- **[CLI Fundamentals](/key_concepts/cli-fundamentals)** - Basic CLI features and type display
- **[CLI Patterns](/key_concepts/cli-patterns)** - Advanced patterns like grouped options and custom program names
- **[Naming Conventions](/key_concepts/naming-conventions)** - How Python names convert to CLI arguments
- **[Help Generation](/key_concepts/help-generation)** - Automatic help text from comments and docstrings

- **[Type System](/key_concepts/type-system)** - Complete type hints reference and type validation
- **[Union Types: Subcommands](/key_concepts/union_types)** - Union types as subcommands, optional parameters, and multi-way dispatching
- **[Environment Variables](/key_concepts/environment_variables)** - Configuration from environment with EnvVar
- **[Parameter Overrides](/key_concepts/parameter-overrides)** - CLI, context managers, and other override methods
- **[Advanced Patterns: Prefixes & Composition](/key_concepts/advanced_patterns)** - Global singleton configs with @proto.prefix, namespaced parameters, and complex composition
- **[Hyperparameter Sweeps](/key_concepts/hyperparameter_sweeps)** - Declarative parameter sweeps with Sweep
- **[Parameter Iteration](/key_concepts/parameter-iteration)** - Lightweight, composable sweeps with `piter @ {...}` syntax
- **[ANSI Formatting](/key_concepts/ansi_formatting)** - Terminal colors and formatting
...
- [Ml Training](/examples/ml_training)
- [Rl Agent](/examples/rl_agent)
- [Cli Applications](/examples/cli_applications)
- [Proto](/reference/configuration)
## Why v3?
...
See the [Migration Guide](/migration) for upgrading from v2.

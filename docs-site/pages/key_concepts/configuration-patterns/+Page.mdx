...
order: 112
description: "Configuration Patterns \u2014 params-proto 3.3.0 documentation."
---
...
See [Type System](/key_concepts/type-system) for details on required parameters.
...
- [Core Concepts](/key_concepts/core-concepts) - The three decorators
...
- [Type System](/key_concepts/type-system) - Complete type annotation reference
- `Advanced Patterns` - Prefixes and subcommands
- [Parameter Overrides](/key_concepts/parameter-overrides) - Ways to override values

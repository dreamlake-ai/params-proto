---
title: "Welcome to params-proto"
section: "Key concepts"
order: 110
description: "Welcome to params-proto \u2014 params-proto 3.3.0 documentation."
---
...
Start with [Configuration Patterns](/key_concepts/configuration-patterns) to learn function-based configs.

**For libraries and reusable components:**
Start with [Core Concepts](/key_concepts/core-concepts) to understand decorators and classes.

**For detailed CLI features:**
Check [CLI Fundamentals](/key_concepts/cli-fundamentals) for naming, help generation, and types.
...
1. Read [Core Concepts](/key_concepts/core-concepts) - Understand the 3 main decorators
2. Pick your pattern:
   - Functions → [Configuration Patterns](/key_concepts/configuration-patterns)
   - Classes → `Advanced Patterns`
   - Union types → `Union Types`
3. Explore features:
   - CLI basics → [CLI Fundamentals](/key_concepts/cli-fundamentals)
   - CLI patterns → [CLI Patterns](/key_concepts/cli-patterns)
   - Environment variables → `Environment Variables`
   - Parameter sweeps → `Hyperparameter Sweeps`

## Documentation

- [Core Concepts](/key_concepts/core-concepts) - Decorators and basic usage
- [Configuration Patterns](/key_concepts/configuration-patterns) - Functions vs classes
- [CLI Fundamentals](/key_concepts/cli-fundamentals) - Building CLIs
- [CLI Patterns](/key_concepts/cli-patterns) - Advanced CLI patterns
- `Union Types` - Subcommands and optional parameters
- `Advanced Patterns` - Prefixes and composition
- [Type System](/key_concepts/type-system) - Supported types and conversion
- `Environment Variables` - EnvVar integration
- [Parameter Overrides](/key_concepts/parameter-overrides) - Multiple override methods
- `Hyperparameter Sweeps` - Systematic exploration
- [Parameter Iteration](/key_concepts/parameter-iteration) - Lightweight sweeps with `piter @ {...}` syntax

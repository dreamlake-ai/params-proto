...
order: 121
description: "Advanced Patterns \u2014 params-proto 3.3.0 documentation."
---
...
See `Parameter Overrides` for details.
...
See `CLI Generation` for details.
...
- [Core Concepts](/key_concepts/core-concepts) - Three main decorators
- [Configuration Patterns](/key_concepts/configuration-patterns) - Function vs class configurations
...
- [Naming Conventions](/key_concepts/naming-conventions) - Name conversion rules
- [Type System](/key_concepts/type-system) - Type annotation reference
- [Parameter Overrides](/key_concepts/parameter-overrides) - Override methods

...
order: 124
description: "ANSI Formatting \u2014 params-proto 3.3.0 documentation."
---
...
- `CLI Generation` - How Python becomes CLI
- [Types Guide](/key_concepts/type-system) - Type annotation support

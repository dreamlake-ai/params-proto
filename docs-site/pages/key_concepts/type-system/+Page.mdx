...
order: 117
description: "Type Annotations \u2014 params-proto 3.3.0 documentation."
---
...
```text
--files [STR]            List of input files (default: ['input.txt'])
--dimensions [INT]       Dimensions to process (default: [128, 256])
--ratios [FLOAT]         Aspect ratios (default: [0.5, 0.3])
```
**How it works:**
...
- [CLI Fundamentals](/key_concepts/cli-fundamentals) - Type display in CLI
- [CLI Patterns](/key_concepts/cli-patterns) - Advanced patterns with type parameters
- `Union Types` - Union types as subcommands
- [Configuration Patterns](/key_concepts/configuration-patterns) - Type annotations in configurations

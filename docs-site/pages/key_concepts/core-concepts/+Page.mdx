...
order: 111
description: "Core Concepts \u2014 params-proto 3.3.0 documentation."
---
...
- Optional: `Optional[T]` (see `Union Types` for workaround)
...
- **For scripts:** Read [Configuration Patterns](/key_concepts/configuration-patterns)
- **For advanced use:** Read `Advanced Patterns`
- **For CLI details:** Read [CLI Fundamentals](/key_concepts/cli-fundamentals)
- **For type details:** Read [Type System](/key_concepts/type-system)

---

## Related

- [Welcome](/key_concepts/welcome) - Introduction and quick start
- [CLI Fundamentals](/key_concepts/cli-fundamentals) - Basic CLI features
- [CLI Patterns](/key_concepts/cli-patterns) - Advanced CLI patterns
- [Configuration Patterns](/key_concepts/configuration-patterns) - Functions vs classes in depth

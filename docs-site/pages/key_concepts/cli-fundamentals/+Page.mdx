...
order: 113
description: "CLI Fundamentals \u2014 params-proto 3.3.0 documentation."
---
...
- [CLI Patterns](/key_concepts/cli-patterns) - Advanced patterns (grouped options, testing, edge cases)
- [Naming Conventions](/key_concepts/naming-conventions) - Parameter and class name conversion rules
- [Help Generation](/key_concepts/help-generation) - Documentation extraction and formatting
- `Union Types` - Union subcommands and optional parameters
